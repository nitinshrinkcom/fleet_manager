...
export default class Vehicle_multiforms4 extends Component {
    render() {
        return (
            <div>
                                                                ...
                                                                <form action="#" method="post" autocomplete="off">
                                                                    <div className="mt-5 text-center wizard-header">
                                                                        <div id="steps_line">
                                                                            ...
                                                                            <div className="step_line active" data-desc="Ajouter des photos"><span>4</span></div>
                                                                    ...
                                                                    <div className="wizard-body mt-18 overflow-auto">
                                                                        <div className="step initial active">
                                                                            <h1 className="text-center wizardboldHeading">AJOUT DES PHOTOS</h1>
                                                                            <div className="card card-bordered card-stretch mt-6 border col-md-8 mx-auto">
                                                                                <div className="card-body">

                                                                                    <div className="row mt-4">
                                                                                        <div className="col-sm-3 col-md-4">
                                                                                            <p className="text-start fw-boldest">PHOTOS</p>
                                                                                        </div>
                                                                                    ...
                                                                                    <div className="row mt-6">
                                                                                        ...
                                                                                        <div className="col-md-2 col-2 mt-3">
                                                                                            <Link to className="text-dark fw-boldest text-decoration-underline"><i className="fas fa-eye text-dark fa-2x"></i></Link>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div className="row">
                                                                                ...
                                                                                <div className="col-md-6 col-sm-12 mt-3">
                                                                                    <Link to="/sin_wizard5" className="btn enregContBtn reggBTN float-end">ENREGISTRER ET CONTINUER</Link>
                                                                                    <Link to="/sin_wizard5" className="btn enregBtn reggBTN me-3 float-end">ENREGISTRER</Link>
                                                                                </div>
                                                                                <div className="col-md-2 col-sm-12"></div>
                                                                            </div>
                                                                        </div>
