                                                            ...
                                                            <div className="wizard card-like">
                                                                <form action="#" method="post" autocomplete="off">
                                                                    <div className="mt-5 text-center wizard-header">
                                                                        <div id="steps_line">
                                                                            <div className="step_line active" data-desc="Nom du sinistre"> <span>1</span></div>
                                                                    ...
                                                                    <div className="wizard-body mt-18">
                                                                        <div className="step initial active">
                                                                            ...
                                                                            <div className="d-flex flex-column justify-content-center align-items-center mt-20 col-md-6 mx-auto">
                                                                                <input type="text" className="form-control" placeholder="Intitule du sinistre" autocomplete="off" required />
                                                                                <div className="d-block mx-auto mt-12">
                                                                                    <Link to="/sin_wizard2" className="sendColorBtn" style={{"background": "red"}}>CREER LE SINISTRE</Link>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
