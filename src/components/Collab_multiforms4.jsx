...
export default class Collab_multiforms4 extends Component {
    render() {
        return (
            <div>
                                                            ...
                                                            <div className="wizard card-like">
                                                                <form action="#" method="post" autocomplete="off">
                                                                    <div className="mt-5 text-center wizard-header">
                                                                        <div id="steps_line">
                                                                            <div className="step_line active" data-desc=""> <span>1</span></div>
                                                                            <div className="step_line active" data-desc="">2</div>
                                                                            <div className="step_line active" data-desc="">3</div>
                                                                            <div className="step_line active" data-desc="Affectation du vehicule"><span>4</span></div>
                                                                    ...
                                                                    <div className="mt-18 overflow-auto">
                                                                        <div className="step initial active">
                                                                            <h1 className="text-center">AFFECTATION DU VEHICULE</h1>
                                                                            <div className="d-flex flex-column justify-content-center align-items center mt-20 col-md-6 mx-auto position-relative">
                                                                                <p className="text-dark text-center fw-bolder">Recherche du vehicule</p>
                                                                                <input type="text" className="form-control form-control-solid rounded-pill" placeholder="" required /><i className="fas fa-search" style={{ "position": "absolute", "top": "38px", "right": "20px" }}></i>
                                                                                <div className="row mt-6">
                                                                                    <div className="col-md-6 col-sm-6">
                                                                                        <label htmlFor="date" className="fw-bolder mt-6"> DATE DE FIN D'AFFECTATION </label>
                                                                                    </div>
                                                                                    <div className="col-md-6 col-sm-6">
                                                                                        <input type="date" className="form-control form-control-solid" name="date" id="date" />
                                                                                    </div>
                                                                                </div>
                                                                                <p className="text-dark text-center fw-bolder mt-6" style={{ "color": "orange !important" }}>Recherche du vehicule</p>
                                                                                <div className="d-block mx-auto mt-15">
                                                                                    <Link to="/collab_wizard5" className="envoyer_gradient">affecter le vehicule </Link>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
