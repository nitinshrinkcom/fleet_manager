                                                                ...
                                                                <form action="#" method="post" autocomplete="off">
                                                                    <div className="mt-5 text-center wizard-header">
                                                                        <div id="steps_line">
                                                                            ...
                                                                            <div className="step_line active" data-desc="Recherche du vehicule"><span>2</span></div>
                                                                    ...
                                                                    <div className="wizard-body mt-18">
                                                                        <div className="step initial active">
                                                                            <h1 className="text-center wizardboldHeading">INTITULE DU SINISTRE</h1>
                                                                            <div className="d-flex flex-column justify-content-center align-items center mt-20 col-md-6 mx-auto position-relative">
                                                                                <p className="text-dark text-center fw-boldest">Recherche du vehicule</p>
                                                                                <input type="text" className="form-control form-control-solid rounded-pill" placeholder="XX-000-XX" required /><i className="fas fa-search" style={{ "position": "absolute", "top": "38px", "right": "20px" }}></i>
                                                                                <div className="row mt-6">
                                                                                    <div className="col-md-3 col-sm-6">
                                                                                        <label htmlFor="date" className="fw-boldest mt-6"> COLLABORATEUR </label>
                                                                                    </div>
                                                                                    <div className="col-md-9 col-sm-6">
                                                                                        <input type="text" className="form-control form-control-solid" name="remp" id="remp" placeholder="Remplissage automatique" />
                                                                                    </div>
                                                                                </div>
                                                                                <p className="text-dark text-center fw-bolder mt-10" style={{ "color": "orange !important"}}>* Recherche du vehicule</p>
                                                                                <div className="d-block mx-auto mt-15">
                                                                                    <Link to="/sin_wizard3" className="envoyer_gradient">affecter le vehicule </Link>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
