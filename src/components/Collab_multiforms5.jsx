...
export default class Collab_multiforms5 extends Component {
                                                                ...
                                                                <form action="#" method="post" autocomplete="off">
                                                                    <div className="mt-5 text-center wizard-header">
                                                                        <div id="steps_line">
                                                                            ...
                                                                            <div className="step_line active" data-desc="Carte essence et badge telepeage"><span>5</span></div>
                                                                    ...
                                                                    <div className="wizard-body mt-18 overflow-auto">
                                                                        <div className="step initial active">
                                                                            <h1 className="text-center">CARTE ESSENCE ET BADGE TELEPEAGE</h1>
                                                                            <div className="d-flex flex-column justify-content-center align-items center mt-20 col-md-8 mx-auto">
                                                                                        ...
                                                                                        <div className="card-body">
                                                                                            <div className="row">
                                                                                                <div className="col-md-4 col-sm-4">
                                                                                                    <h3 className="text-start fw-bolder">CARTE ESSENCE</h3>
                                                                                                </div>
                                                                                            ...
                                                                                            <div className="row mt-6">
                                                                                                <div className="col-md-4 col-sm-4">
                                                                                                    <h3 className="text-start fw-bolder mt-4">CARTE N<sup>o</sup></h3>
                                                                                                </div>
                                                                                                <div className="col-md-8 col-sm-8">
                                                                                                    <input type="text" class="form-control form-control-solid" defaultValue="99234" />
                                                                                                </div>
                                                                                            </div>
                                                                                ...
                                                                                <div className="card-2 mt-6">
                                                                                    <div className="card card-bordered card-stretch">
                                                                                        <div className="card-body">
                                                                                            <div className="row">
                                                                                                <div className="col-md-4 col-sm-4">
                                                                                                    <h4 className="text-start fw-bolder">TELEPEAGE</h4>
                                                                                                </div>
                                                                                                <div className="col-md-8 col-sm-8">
                                                                                                    <p className="text-start fw-bolder" style={{ "color": "orange" }}>Formats acceptes: Jpeg, Jpg et Png. Taille: moins de 10 Mo</p>
                                                                                                </div>
                                                                                            ...
                                                                                            <div className="row mt-6">
                                                                                                <div className="col-md-4 col-sm-4">
                                                                                                    <h4 className="text-start fw-bolder mt-4">BADGE N<sup>o</sup></h4>
                                                                                                </div>
                                                                                                <div className="col-md-8 col-sm-8">
                                                                                                    <input type="text" class="form-control form-control-solid" defaultValue="99234" />
                                                                                                </div>
                                                                                ...
                                                                                <div className="row mt-5">
                                                                                    ...
                                                                                    <div className="col-md-3 col-sm-12">
                                                                                        <Link to="/collab_wizard6" className="btn enregBtn reggBTN float-right">ENREGISTRER</Link>
                                                                                    </div>
                                                                                    <div className="col-md-4 col-sm-12">
                                                                                        <Link to="/collab_wizard6" className="btn enregContBtn reggBTN float-right">ENREGISTRER ET CONTINUER</Link>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
