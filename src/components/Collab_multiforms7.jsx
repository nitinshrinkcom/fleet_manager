                                            ...
                                            <div className="card card-bordered h-450px">
                                                <div className="card-body d-grid">
                                                    <div className="d-flex flex-column justify-content-center align-items-center">
                                                        <p className="text-center fw-boldest">Fiche Collaborateur validee</p>
                                                        <Link to="#" className="btn dashboardBtnGradient text-dark fw-bold"><i className="fas fa-eye me-1 text-dark"></i> VOIR LE COLLABORATEUR</Link>
